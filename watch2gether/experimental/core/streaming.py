...
@router.get('/experimental/video/{video_name}/')
async def redirect_streaming_wrapper(video_name: str) -> RedirectResponse:
    ...
    """
    return RedirectResponse(url=f'/experimental/videos/{video_name}/{video_name}.m3u8',  # noqa: E501
                            status_code=301)


@router.get('/experimental/videos/{video_directory}/{file_name}')
